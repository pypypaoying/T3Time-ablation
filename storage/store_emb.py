...
def parse_args():
    ...
    parser.add_argument("--root_path", type=str, default=os.environ.get("T3TIME_DATA_ROOT", "./dataset/"))
    parser.add_argument("--embed_root_path", type=str, default=os.environ.get("T3TIME_EMBED_ROOT", "./Embeddings/"))
...
def save_embeddings(args):
    ...
    save_path = os.path.join(args.embed_root_path, args.data_path, args.divide)
